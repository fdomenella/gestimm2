...
$str="";
		...
		$str.= "<TR>\n";
			...
			$str.="<br><br>";
			$str.="<a href=\"immobile_archivia.php?azione=arc&id_imm=$id_imm";
...
if ($_GET['azione']=="arc") {
	 ...
	 */
	$query="UPDATE immobile set archiviato=1 where id_imm=".$_GET['id_imm'];
	...
	echo "<SCRIPT>\n\n";
	echo "alert(\"Immobile archiviato correttamente. Clicca ok per proseguire\");\n";
