...
class boxRicerca{
	...
	function __construct(){
		...
		*/
			...
			<img src="images/false.png" id="imgCheck0" style="border: none;" alt="checkbox" />
			...
			$this->BoxRicerca.='<label class="boxRicercaLabel" for="tipo">
			<a href="javascript:checkBox(1)">
			<img src="images/false.png" id="imgCheck1" style="border: none;" alt="checkbox" />
			
			Affitto</a></label>';
			$this->BoxRicerca.='
			<input type="hidden" name="input_check[0]" id="inputCheck0" value="false" />
			<input type="hidden" name="input_check[1]" id="inputCheck1" value="false" />
			';
